...
gz sim -v4 -r aruco_rover_runway.sdf;
exec bash
"
...
gz topic -t /world/aruco_rover_runway/model/copter-01/model/gimbal/link/pitch_link/sensor/camera/image/enable_streaming -m gz.msgs.Boolean -p 'data: 1';
exec bash
"
